...
public class ExcelUtilis {
	...
	WebDriver driver;
			...
			public String[][] Detdata() throws BiffException, IOException {
				FileInputStream excel = new FileInputStream("D:\\testing document\\TestData12.xls");
			...
			public void BothWRG(String URL,String USname,String PWD) throws InterruptedException {
				//System.setProperty("webdriver.chrome.driver", "C:\\Users\\yuvaraj.murugesan\\Pictures\\Saved Pictures\\chromedriver-win32\\chromedriver.exe");
